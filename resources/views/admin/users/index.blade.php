                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="btn-group me-2" role="group">
                                            <a href="{{ route('admin.users.index') }}" 
                                               class="btn btn-outline-secondary {{ !request('role') ? 'active' : '' }}">
                                                Tất cả
                                            </a>
                                            <a href="{{ route('admin.users.index', ['role' => '0']) }}" 
                                               class="btn btn-outline-danger {{ request('role') === '0' ? 'active' : '' }}">
                                                Admin
                                            </a>
                                            ...
                                            <a href="{{ route('admin.users.index', ['role' => 'assistant']) }}" 
                                               class="btn btn-outline-warning {{ request('role') === 'assistant' ? 'active' : '' }}">
                                                Trợ lý
                                            </a>
                                            <a href="{{ route('admin.users.index', ['role' => 'student']) }}" 
                                               class="btn btn-outline-primary {{ request('role') === 'student' ? 'active' : '' }}">
                                                Học viên
                                            </a>
                                        </div>
                                    </div>
                                                        ...
                                                        @if($user->id !== auth()->id())
                                                            <form action="{{ route('admin.users.toggleStatus', $user) }}" 
                                                                ...
                                                                <button type="submit" 
                                                                    ...
                                                                    <i data-feather="{{ $user->is_active ? 'user-x' : 'user-check' }}" class="icon-xs"></i>
                                                                </button>
                                                            </form>
                                                        @endif
                                                                            ...
                                                                            <div class="modal-body p-4">
                                                                                <div class="text-center mb-3">
                                                                                    <div class="avatar avatar-lg mb-3">
                                                                                        <span class="avatar-text rounded-circle bg-danger-soft text-danger">
                                                                                            <i data-feather="alert-triangle" class="icon-md"></i>
                                                                                        </span>
                                                                                    </div>
                                                                                    <h5 class="mb-3">Bạn có chắc chắn muốn xoá?</h5>
                                                                                    <p class="mb-0">Người dùng <span class="fw-bold text-danger">{{ $user->name }}</span>
                                                                                        sẽ bị xóa khỏi hệ thống.</p>
                                                                                </div>
                                                                            </div>
                                                                            <div class="modal-footer border-top-0 pt-0 pb-3 px-4">
                                                                                <button type="button" class="btn btn-light-soft" data-bs-dismiss="modal">
                                                                                    <i data-feather="x" class="icon-xs me-1"></i> Huỷ bỏ
                                                                                </button>
                                                                                <button type="submit" class="btn btn-danger">
                                                                                    <i data-feather="trash-2" class="icon-xs me-1"></i> Xoá
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
