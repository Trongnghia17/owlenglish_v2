...
export default function PagesTest() {
  ...
  return (
    <div className="pages-test">
      {/* Header */}
      <div className="pages-test__header-wrapper">
        {/* Breadcrumb */}
        <div className="pages-test__breadcrumb">
          <span className="pages-test__breadcrumb-item" onClick={() => navigate('/')}>Trang chủ</span>
          <span className="pages-test__breadcrumb-separator"><svg xmlns="http://www.w3.org/2000/svg" width="16"
  ...
  <path
      ...
      fill="#6D6D6D"/>
          ...
          <span className="pages-test__breadcrumb-item pages-test__breadcrumb-item--active">Đề thi online</span>
        </div>

        <div className="pages-test__header-top">
          <h1 className="pages-test__title">Thư viện đề thi Online</h1>
          <div className="pages-test__header-controls">
            <div className="pages-test__search">
              <svg
                  className="pages-test__search-icon"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              >
              ...
              <input
                  type="text"
                  className="pages-test__search-input"
                  placeholder="Tìm kiếm"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
              />
            </div>
            <div className="pages-test__sort">
              <div className="pages-test__sort-wrapper">
                <select
                  className="pages-test__sort-select"
                  value={sortBy}
                ...
                <svg className="pages-test__sort-arrow" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <div className="pages-test__content">
      {/* Sidebar */}
      <aside className="pages-test__sidebar">
        {/* Writing Section */}
      ...
      {/* Main Content */}
      <main className="pages-test__main">
        {loading ? (
          <div className="pages-test__loading">Đang tải dữ liệu...</div>
        ) : sortedSkills.length === 0 ? (
          <div className="pages-test__empty">Không có bài thi nào</div>
        ) : (
          <div className="pages-test__grid">
            {sortedSkills.map(skill => (
              <div
                key={skill.id}
                className="pages-test__card"
                onClick={() => handleSkillClick(skill)}
              >
                <img
                  src={getSkillImage(skill)}
                  alt={skill.name}
                  className="pages-test__card-image"
                  onError={(e) => {
                    e.target.src = 'https://via.placeholder.com/280x180/6366f1/ffffff?text=No+Image';
                  }}
                />
                <div className="pages-test__card-content">
                  <h3 className="pages-test__card-title">{skill.name}</h3>
                  <p className="pages-test__card-subtitle">
                    Tiền trình: <span className="pages-test__card-skill-type">{getSkillTypeLabel(skill.skill_type)}</span>
                   
                  </p>
                  <div className="pages-test__card-footer">
                    <button className="pages-test__card-button">
                      Thi ngay
                      <span className="pages-test__card-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
