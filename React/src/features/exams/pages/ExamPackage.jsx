...
import { getExamCollections, getCollections } from '../api/exams.api';
...
export default function ExamPackage() {
  ...
  const fetchSkills = async (page = 1) => {
    ...
    try {
      ...
      const response = await getExamCollections(params);
    ...
    <div className="online-exam-library online-exam-library--exam-package">
      ...
      <div className="online-exam-library__content">
        ...
        <main className="online-exam-library__main">
          <div className='exam-package-container'>
            <aside className="exam-collection-library__sidebar">
              <ul className="exam-collection-list">
                {collections.map(col => (
                  <li
                    key={col.id}
                    className={collectionIds.includes(col.id) ? 'active' : ''}
                    onClick={() => {
                  ...
                  >
                    ...
                    <img
                      src={muiten}
                      alt="muiten"
                      className={collectionIds.includes(col.id) ? 'rotate' : ''}
                    />
                  </li>
