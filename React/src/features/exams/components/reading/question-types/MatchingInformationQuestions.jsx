...
const MATCHING_DRAG_TYPE = 'application/x-reading-matching-answer';
...
function MatchingInformationQuestions({ group, answers, onAnswerChange }) {
  ...
  return (
    <div className="reading-test__matching-layout">
      {/* Passage / Paragraph reference column */}
      <section className="reading-test__matching-card reading-test__matching-card--passage">
        <h4 className="reading-test__matching-card-title">Passage paragraphs</h4>
          ...
          {options.map((opt) => {
            ...
            return (
              ...
              >
                ...
                <span className="reading-test__matching-option-text">{opt.content || `Paragraph ${opt.letter}`}</span>
                <span className="reading-test__matching-option-handle" aria-hidden="true" />
              </button>
            );
          })}
        </div>
