...
function MatchingHeadingsQuestions({ group, answers, onAnswerChange }) {
  ...
  return (
    <div className="reading-test__matching-layout">
      ...
      <aside className="reading-test__matching-card reading-test__matching-card--options">
        <h4 className="reading-test__matching-card-title">List of Headings</h4>
      ...
      <section className="reading-test__matching-card">
        <h4 className="reading-test__matching-card-title">Paragraphs</h4>
